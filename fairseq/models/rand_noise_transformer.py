...
@register_model('rand_noise_transformer')
class RandNoiseTransformerModel(FairseqModel):
    """
    ...
    def add_args(parser):
        ...
        parser.add_argument('--out-noise', default=False, action='store_true',
    ...
    def build_model(cls, args, task):
        ...
        return RandNoiseTransformerModel(encoder, decoder)
...
class TransformerEncoder(FairseqEncoder):
    ...
    def forward(self, src_tokens, src_lengths):
        ...
        if self.out_noise and self.training:
            noise = torch.randn_like(x)
            x += self.noise_ratio * noise
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_iwslt_de_en')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_wmt_en_de')
def transformer_wmt_en_de(args):
    base_architecture(args)


@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_t2t_wmt_en_de')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_relative_transformer_wmt_en_de')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_relative_transformer_t2t_wmt_en_de')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_vaswani_wmt_en_de_big')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_vaswani_wmt_en_fr_big')
def transformer_vaswani_wmt_en_fr_big(args):
    args.dropout = getattr(args, 'dropout', 0.1)
    transformer_vaswani_wmt_en_de_big(args)


@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_wmt_en_de_big')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_transformer_wmt_en_de_big_t2t')
...
@register_model_architecture('rand_noise_transformer', 'rand_noise_relative_transformer_test')
